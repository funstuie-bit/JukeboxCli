...
| Visible player navigation and editable queue | In progress | Full-app keyboard workflow |
| Saved listening sessions | Planned | Restart, missing files, shuffle |
| Streaming and next-track preload | Planned | Local/remote transitions |
| YouTube Music search and browsing | Planned | Provider/auth prototype |
